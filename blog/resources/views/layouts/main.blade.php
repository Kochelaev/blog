...
<head>
    ...
    <title>blog</title>
    <link rel="stylesheet" {{asset("assets/vendors/flag-icon-css/css/flag-icon.min.css")}}>
    <link rel="stylesheet" {{asset("assets/vendors/font-awesome/css/all.min.css")}}>
    <link rel="stylesheet" {{asset("assets/vendors/aos/aos.css")}}>
    <link rel="stylesheet" {{asset("assets/css/style.css")}}>
